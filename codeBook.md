 The column "activity" gives the activity name
 
 The column "subject" gives the subject identifier number (between 1 and 30)
 
 Rest of the columns give the average of the variables grouped ny activity and subject
